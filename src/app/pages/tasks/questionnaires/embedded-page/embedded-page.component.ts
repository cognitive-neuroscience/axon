...
export class EmbeddedPageComponent implements OnInit, OnDestroy {
                    ...
                    .subscribe((data) => {
                        if (!data || !data.url) {
                            this.snackbar.openErrorSnackbar(
                                "Could not find page. Please proceed to the next step and contact the sharp lab."
                            );
                            return;
                        }
    ...
    proceed() {
        const msg =
            "Did you finish? Please note that we will not be able to compensate you if you have not completed the given activity.";
