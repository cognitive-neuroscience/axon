...
@Component({
    selector: 'app-choicer-dutch',
    templateUrl: './choicer-dutch.component.html',
    styleUrls: ['./choicer-dutch.component.scss', '../rater-dutch/rater-dutch.component.scss'],
})
export class ChoicerDutchComponent extends AbstractBaseTaskComponent implements OnDestroy {
    /**
     * Task summary:
